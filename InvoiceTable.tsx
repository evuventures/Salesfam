        ...
        <div className="flex items-center justify-center">
          <Dialog>
            <DialogTrigger asChild>
              <FolderEdit className="mx-1 w-[20px] cursor-pointer text-green-500" />
            </DialogTrigger>
            <DialogContent className="bg-white sm:max-w-[425px]">
              <DialogHeader>
                <DialogTitle>Edit Invoice</DialogTitle>
                <DialogDescription>
                  Make changes to your invoice here. Click save when you are
                  done.
                </DialogDescription>
              </DialogHeader>
              <Editinvoice value={row.getValue("_id")} />
            </DialogContent>
          </Dialog>

          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Trash2 className="mx-1 w-[20px] cursor-pointer text-red-600" />
            </AlertDialogTrigger>
            <AlertDialogContent className="bg-white">
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  invoice and remove data from servers.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  ...
                  onClick={async () => {
                    const res = await fetch(
                      `/api/invoice?invoiceid=${row.getValue("_id")}`,
                      {
                        method: "DELETE",
                      }
                    )
