              ...
              <form className="mb-10" onSubmit={handleImageUpload}>
                ...
                <div className="mb-5 grid w-full items-center gap-1.5">
                  ...
                  <div className="my-2 ml-5">
                    <Label className="inline-block py-1">
                        Facebook:
                    </Label>
                        <Input type="text" placeholder="facebook link" name="facebook" value={socialLink.facebook} onChange={handleSocialLink} />
                </div>
                <div className="my-2 ml-5">
                    <Label className="inline-block py-1">
                        Twitter:
                    </Label>
                        <Input type="text" placeholder="twitter link" name="twitter" value={socialLink.twitter} onChange={handleSocialLink} />
                </div>
                <div className="my-2 ml-5">
                    <Label className="inline-block py-1">
                        Instagram:
                    </Label>
                        <Input type="text" placeholder="instagram link" name="instagram" value={socialLink.instagram} onChange={handleSocialLink} />
                </div>
                <div className="my-2 ml-5">
                    <Label className="inline-block py-1">
                        LinkedIn:
                    </Label>
                        <Input type="text" placeholder="linkedin link" name="linkedin" value={socialLink.linkedin} onChange={handleSocialLink} />
                </div>
                </div>
                <div className="mb-5 grid w-full items-center gap-1.5">
